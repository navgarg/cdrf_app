...
class DashboardService {
  List<DailySummary> getWeeklyData(List<Transaction> transactions, DateTime focusedDate) {
  ...
  List<DailySummary> getMonthlyData(List<Transaction> transactions, DateTime focusedDate) {
  ...
  List<DailySummary> getDailyData(List<Transaction> transactions, DateTime focusedDate) {
