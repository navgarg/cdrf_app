...
import 'package:nariudyam/models/user.dart';
          ...
          child: Row(
            ...
            children: [
              IconButton(
                ...
                onPressed: () => onWeekNavigate(focusedDay.subtract(const Duration(days: 7))),
              ),
              Text(
              ...
              IconButton(
                ...
                onPressed: () => onWeekNavigate(focusedDay.add(const Duration(days: 7))),
              ),
            ],
          ),
        ),
          ...
          child: weekAppointments.isEmpty
            ...
            itemBuilder: (context, index) {
              ...
              final bool showHeader = index == 0 ||
                  (appointment.dateTime.year != weekAppointments[index - 1].dateTime.year ||
                      appointment.dateTime.month != weekAppointments[index - 1].dateTime.month ||
                      appointment.dateTime.day != weekAppointments[index - 1].dateTime.day);
