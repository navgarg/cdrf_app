...
class DayView extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    if (selectedDay == null) {
      return const Center(child: Text("Select a day to see appointments."));
    }
    ...
    final dayAppointments = allAppointments
        .where((a) => a.dateTime.year == selectedDay!.year && a.dateTime.month == selectedDay!.month && a.dateTime.day == selectedDay!.day)
        .toList()
            ...
            child: Row(
              ...
              children: [
                IconButton(
                  ...
                  onPressed: () => onDayNavigate?.call(selectedDay!.subtract(const Duration(days: 1))),
                ),
                Text(
                ...
                IconButton(
                  ...
                  onPressed: () => onDayNavigate?.call(selectedDay!.add(const Duration(days: 1))),
                ),
              ],
            ),
          ),
